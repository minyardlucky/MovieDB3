...
    background: #333333 !important; /* Medium Gray Inside Marquee */
...
      
      {/* 2. Outer container for centering and full screen height */}
      <div className="flex justify-center items-center center-screen bg-gray-900">
        
        {/* 3. Inner marquee container with style classes */}
